...
public class MatrixSolverComplete {
	...
	// change inputMatrix to matrix and change numOfPivots to pivots
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length == 2) {
			...
			// Introduction
			System.out.println("\nThis program gives a complete solution for a system of"
					+ "linear equations (A x = b) as described by any m x n matrix.");
